/**
 * Enhanced Login Page
 * Uses centralized auth and improved error handling
 */
...
import { supabase, debugSession, clearOldSessions } from '@/lib/supabaseClient'
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          <div className="text-center">
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              <p className="text-sm text-gray-600 mb-4">Debug Tools:</p>
