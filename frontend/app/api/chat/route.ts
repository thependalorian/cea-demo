...
export async function POST(request: NextRequest) {
  try {
    ...
    const requestData = {
      id: request_id || randomUUID(),
      user_id: user_id || randomUUID(), // Generate proper UUID instead of 'demo_user'
      user_query: content, // Changed back to user_query to match backend model
